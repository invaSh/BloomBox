        ...
        <div class="row h-100">
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark col-lg-3 sidebar"
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="#categoriesSubmenu" data-bs-toggle="collapse" aria-expanded="false"
                            class="nav-link dropdown-toggle">
                            <i class="bi bi-tags" width="16" height="16"></i>
                            Categories
                        </a>
                        <ul class="collapse list-unstyled" id="categoriesSubmenu">
                            <li><a href="{{ url('/admin/category/list') }}" class="nav-link"><i
                                        class="bi bi-arrow-right"width="16" height="16"></i>View all categories</a>
                            </li>
                            <li><a href="{{ url('/admin/category/create') }}" class="nav-link"><i
                                        class="bi bi-arrow-right"width="16" height="16"></i>Create new category</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#occasionsSubmenu" data-bs-toggle="collapse" aria-expanded="false"
                            class="nav-link dropdown-toggle">
                            <i class="bi bi-flower2" width="16" height="16"></i>
                            Occasions
                        </a>
                        <ul class="collapse list-unstyled" id="occasionsSubmenu">
                            <li><a href="{{ url('/admin/occasion/list') }}" class="nav-link"><i
                                        class="bi bi-arrow-right"width="16" height="16"></i>View all occasions</a>
                            </li>
                            <li><a href="{{ url('/admin/occasion/create') }}" class="nav-link"><i
                                        class="bi bi-arrow-right"width="16" height="16"></i>Create new occasion</a>
                            </li>
                        </ul>
                    </li>
                </ul>
