            ...
            <div class="row gx-5">
                    ...
                    <div class="card text-dark h-100 shadow border-0">
                        ...
                        <div class="card-body p-4">
                            <a class="text-decoration-none link-dark stretched-link" href="#!">
                                <h5 class="card-title mb-3">Dozen Pastel Roses</h5>
                            </a>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card text-dark h-100 shadow border-0">
                        ...
                        <div class="card-body p-4">
                            <a class="text-decoration-none link-dark stretched-link" href="#!">
                                <h5 class="card-title mb-3">Blue Roses</h5>
                            </a>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card text-dark h-100 shadow border-0">
                        ...
                        <div class="card-body p-4">
                            <a class="text-decoration-none link-dark stretched-link" href="#!">
                                <h5 class="card-title mb-3">Pink, Peach And Purple Perfection</h5>
                            </a>
                    ...
                    <div class="row">
                        <div class="offset-xl-3 col-xl-6 col-md-12">
                            ...
                            <div class="text-center mb-8">
                                ...
                                <!-- para -->
                                <p class="text-muted">Our average call quality rating is 4.4 out of 5. That leads to happy
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="card mb-6 mb-lg-0">
                                ...
                                <div class="card-body p-6">
                                    ...
                                    <p class="fw-semibold">"Geeks has created an incredibly seamless
                                    ...
                                    <div class="d-flex mt-4 align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="mb-0">Ronald Richards</h5>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-6">
                                    <i class="mdi mdi-48px mdi-format-quote-open text-light-primary lh-1 mb-3 d-block"></i>
                                    <p class="text-dark fw-semibold">"I am very satisfied with my purchase. Your team
                                    ...
                                    <div class="d-flex mt-4 align-items-center">
                                        <img src="../assets/images/avatar/avatar-9.jpg" alt=""
                                            class="avatar avatar-md rounded-circle">
                                        <div class="ms-2">
                                            <h5 class="mb-0">Darlene Robertson</h5>
