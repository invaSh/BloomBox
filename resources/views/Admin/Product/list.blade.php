<x-admin-layout>
    ...
    @endif
    <div class="container mt-5 customCont mb-5">
        <img src=" {{ asset('img/banner.jpg') }}" class="img img-fluid" id="productListImg" alt="">
        <table class="table table-striped text-center customTable align-items-center">
            <h1 class="text-center mb-3" style="margin-top: 5rem">All products</h1>
            <thead class="">
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Id</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="dropdown drop-custom">
                                ...
                                <ul class="dropdown-menu bg-secondary text-primary"
